...
- The opencode adapter writes only `.opencode/agents/`. It does NOT own `.opencode/opencode.json` or any other `.opencode/*` files — those remain hand-authored and tracked.
